    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a class="nav-link active" href="supervisor_admin_transaction.php">Supervisor - Admin Transaction</a>
            </li>
            <li class="nav-item">
        ...
        <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
          ...
          <h2>Supervisor List</h2>
           ...
           <form class="col-lg-3" method="POST" action="supervisor_admin_transaction.php">
          ...
          <?php
            ...
            if(isset($_POST["btn"])){
              ...
              if($diff>0 && $diff < 180){
                  $q1 = "SELECT * FROM supervisor_admin_transaction WHERE date_time>= '$sdate' AND date_time <= '$fdate' ";
          ...
          ?>
          <div style="float: right; margin: 10px;<?php if($num==0) echo "display: none;"; ?>"><a href="export_supervisor_admin_transaction.php?sdate=<?php echo $sdate ?>&fdate=<?php echo $fdate ?>" ><button class='btn btn-info btn-lg'>Export</button></a></div>
              ...
              <tbody>
                ...
                <?php
                  ...
                  while($row = mysqli_fetch_assoc($r1)){
                    ...
                    echo "<td><a href='delete_supervisor_admin_transaction.php?id=".$row['id']."'><button class='btn btn-outline-danger btn-sm'>Delete</button></a></td></tr>";
                    $i=$i+1;
                  }
              }
              else if($diff == 0){
