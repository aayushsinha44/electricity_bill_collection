      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="collector_consumer_transaction.php">Collector - Consumer Transaction</a>
            </li>
          </ul>
        ...
        <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
          ...
          <h2>Supervisor List</h2>
           ...
           <form class="col-lg-3" method="POST" action="collector_consumer_transaction.php">
