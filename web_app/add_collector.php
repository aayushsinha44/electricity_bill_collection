...
if(isset($_POST["btn"])){
  ...
  $q = "SELECT * FROM collector WHERE user_id='$user_id'";
  ...
  if(mysqli_num_rows($r)==0){
    ...
    $email = $_POST["email"];
    $query = "INSERT INTO collector (user_id,name,address,phone_number,password,email,cash_in_hand,supervisor_id) VALUES ('$user_id','$name','$address','$phone_number','$password','$email','0','$supervisor_id')";
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="add_collector.php">Add Collector</a>
            </li>
            <li class="nav-item">
