      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="supervisor.php">Supervisors</a>
            </li>
            <li class="nav-item">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <?php
                  ...
                  include('api/config/conn.php');
                  $a = 20 * ($page-1);
                  $q1 = "SELECT * FROM supervisor LIMIT 20 OFFSET ".$a;
                  ...
                  while($row = mysqli_fetch_assoc($r1)){
                    ...
                    echo "<td><a href='update_supervisor.php?id=".$row['user_id']."'><button class='btn btn-outline-success btn-sm'>Update</button></td>";
                    echo "<td><a href='delete_supervisor.php?id=".$row['user_id']."'><button class='btn btn-outline-danger btn-sm'>Delete</button></a></td></tr>";
                    $i=$i+1;
                  }

                  if(isset($_POST["next"])) header("Location: supervisor.php?page=".($page+1));
                  if(isset($_POST["prev"])) header("Location: supervisor.php?page=".($page-1));
                ?>
              </tbody>
            </table>
